...
export function AvatarCropper({ imageFile, onClose, onCropComplete }: AvatarCropperProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div className="bg-bg-card border border-border w-full max-w-md rounded-[var(--radius-lg)] shadow-2xl flex flex-col overflow-hidden animate-fade-in">
        <div className="p-4 border-b border-border flex justify-between items-center">
          <h3 className="font-semibold text-text-primary text-lg">Crop Profile Photo</h3>
