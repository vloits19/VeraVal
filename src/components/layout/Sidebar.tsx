    ...
    <>
      ...
      >
        ...
        <div className="p-4 border-t border-border flex flex-col gap-2">
          {profile ? (
            <>
              <div className="flex items-center gap-3 px-3 py-2 rounded-[var(--radius-md)] bg-bg-card">
                <Avatar
              ...
              <button
                ...
                className="
                  ...
                  text-sm font-medium text-text-secondary hover:text-danger
                  hover:bg-danger/10 rounded-[var(--radius-md)] transition-colors
                  cursor-pointer
                "
              >
